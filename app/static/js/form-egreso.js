...
document.addEventListener('DOMContentLoaded', function () {
    ...
    egresoForm.addEventListener('submit', function (e) {
        ...
        // Confirmar el envío
        Swal.fire({
            title: '¿Confirmar registro de egreso?',
            ...
            if (result.isConfirmed) {
                ...
                // Dentro del evento submit del formulario, reemplaza la línea:
                document.getElementById('fecha_hora').value = new Date().toISOString();
